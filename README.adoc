...
$ podman run --name inventory_service --network pharmacy --env-file ~/.containers-labs.env -p ${INVENTORY_PORT}:5001 \
    --health-cmd='curl http://0.0.0.0:${INVENTORY_PORT}/view_inventory || exit 1' \
