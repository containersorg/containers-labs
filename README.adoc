...
We install K3s as a system service. (Be patient, this process takes some minutes.)
...
$ sudo kubectl get pods -n pharmacy
NAME                                    READY   STATUS    RESTARTS   AGE
billing-deployment-55948d7c67-h2vp5     1/1     Running   0          12s
customer-deployment-75d889bb6c-f2z9w    1/1     Running   0          12s
inventory-deployment-649bbcfcf5-s8tmx   1/1     Running   0          12s
order-deployment-7b9f9985db-4spc6       1/1     Running   0          12s
----
