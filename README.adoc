...
$ podman run --name inventory_service --network pharmacy -p ${INVENTORY_PORT}:5001 -d localhost/pharmacy:v5 inventory_service.py
$ podman run --name customer_service --network pharmacy -p ${CUSTOMER_PORT}:5003  -d localhost/pharmacy:v5 customer_service.py
$ podman run --name billing_service --network pharmacy -p ${BILLING_PORT}:5004  -d localhost/pharmacy:v5 billing_service.py
$ podman run --name order_service --network pharmacy -v pharmacy_orders_data:/data:rw -p ${ORDER_PORT}:5002  -d localhost/pharmacy:v5 order_service.py
----
