...
[source,shell]
----
$ podman run --name inventory_service --network host --env-file ~/.containers-labs.env -d localhost/inventory_image:manual python3 inventory_service.py
$ podman run --name customer_service --network host --env-file ~/.containers-labs.env -d localhost/customer_image:manual python3 customer_service.py
$ podman run --name billing_service --network host --env-file ~/.containers-labs.env -d localhost/billing_image:manual python3 billing_service.py
$ podman run --name order_service --network host --env-file ~/.containers-labs.env -d localhost/order_image:manual python3 order_service.py
----
